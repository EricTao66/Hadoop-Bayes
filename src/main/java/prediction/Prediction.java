...
public class Prediction {
    ...
    Prediction() throws IOException, URISyntaxException {
        ...
        while (reader.ready()) {
            ...
            //System.out.println(String.format("%s:%f",classname+"&"+term,(count+1)/(class_term_total.get(classname)+class_term_num.get(classname))));
        }
    }
